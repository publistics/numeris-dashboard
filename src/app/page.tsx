...
import {
  ...
  ShoppingBag, Package, Landmark, Star, Shield, Zap, Menu, X, Calculator,
} from 'lucide-react';
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-lg border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="/dashboard" className="flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-indigo-600 bg-indigo-50 hover:bg-indigo-100 rounded-lg transition-colors">
      ...
      {/* Problem / Solution */}
      <section id="how-it-works" className="bg-slate-50 py-20 reveal">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12 reveal" style={{ transitionDelay: '100ms' }}>
      ...
      {/* Features Grid */}
      <section id="features" className="max-w-7xl mx-auto px-6 py-20 reveal">
        <div className="text-center mb-12 reveal" style={{ transitionDelay: '100ms' }}>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 reveal">
        <div className="text-center mb-12 reveal" style={{ transitionDelay: '100ms' }}>
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">See What You&apos;re Really Making</h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Move the sliders to see how hidden fees and ad spend eat into your bottom line — and how Numeris brings clarity.
          </p>
        </div>
      ...
      {/* Pricing */}
      <section id="pricing" className="bg-slate-50 py-20 reveal">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12 reveal" style={{ transitionDelay: '100ms' }}>
      ...
      {/* CTA */}
      <section className="max-w-7xl mx-auto px-6 py-20 reveal">
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-3xl p-12 md:p-16 text-center text-white reveal" style={{ transitionDelay: '100ms' }}>
